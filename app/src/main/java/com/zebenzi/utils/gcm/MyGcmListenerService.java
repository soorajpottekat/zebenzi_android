...
public class MyGcmListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
         ...
         */
        sendZebenziNotification(message);
        // [END_EXCLUDE]
    }
    // [END receive_message]
...
// mId allows you to update the notification later on.
    ...
    private int parseMessage(String msgBody) {

        String header = "[zbzc";
//        String s = "[zbzc1005]";
        if (msgBody.indexOf("[zbzc") != -1) {
            //Valid zebenzi customer SMS
            String newString = msgBody.substring(msgBody.indexOf("[zbzc")+header.length(), msgBody.indexOf("]"));
